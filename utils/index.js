// File taken from https://github.com/vuejs-templates/webpack/blob/develop/utils/index.js, thanks again.
 ...
 * @param {string} executable 'npm' or 'yarn'
 * @param {object} data Data from questionnaire
 */
...
To get started:
  ...
  ${yellow(
    `${data.inPlace ? '' : `cd ${data.destDirName}\n  `}${installMsg(data)}npm run watch:dev (or if using yarn: yarn watch:dev)`
  )}
